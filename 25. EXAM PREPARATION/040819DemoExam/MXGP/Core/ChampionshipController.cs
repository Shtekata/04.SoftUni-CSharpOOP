...
namespace MXGP.Core
{
    public class ChampionshipController : IChampionshipController
    {
        ...
        public string CreateMotorcycle(string type, string model, int horsePower)
        {
            ...
            var result = $"{motorcycle.GetType().Name} {model} is created.";
        ...
        public string StartRace(string raceName)
        {
            ...
            sb.AppendLine($"Rider {riders[0].Name} wins {race.Name} race.")
                .AppendLine($"Rider {riders[1].Name} is second in {race.Name} race.")
                .AppendLine($"Rider {riders[2].Name} is third in {race.Name} race.");

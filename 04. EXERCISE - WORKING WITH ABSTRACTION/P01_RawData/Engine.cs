...
namespace P01_RawData
{
    public class Engine
    {
        ...
        private Car CreateCar(string[] parameters)
        {
            ...
            var fouthTire = new Tire(fourthTireAge, fourthTirePressure);

            var car = new Car(model, engineSpeed, enginePower, cargoWeight, cargoType, firstTire, secondTire, thirdTire, fouthTire);

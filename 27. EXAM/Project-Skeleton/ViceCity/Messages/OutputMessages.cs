...
namespace ViceCity.Messages
{
    public class OutputMessages
    {
        ...
        public const string SuccessfullAddWeapodToMainPlayer = "Successfully added {0} to the Main Player: Tommy Vercetti";

        public const string PlayerNotExist = "Civil player with that name doesn't exists!";

        public const string SuccessfullAddWeaponToCivilPlayer = "Successfully added {0} to the Civil Player: {1}";

        public const string EverythingIsOkay = "Everything is okay!";

        public const string FightHappened = "A fight happened:";

        public const string TommiLifePoints = "Tommy live points: {0}!";
